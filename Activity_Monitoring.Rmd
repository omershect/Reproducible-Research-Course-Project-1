...
Processing:
Creating new column which hold the week of the day (Sunda, Monday, ...)based on the date
Create a colomns weekend  1 - Weekend (Saturday or Sunday) , 0 rest of the week days 
Based on the Weekend paramter create a mean _interval data frame which is grouped by Week end or not 
...
Plot
using ggplot crate a Panel plot comparing the average number of steps taken per 5-minute interval across weekdays and weekends
```{r}
#plot a time serial of the avaarge number of stesp (withot missing values)
